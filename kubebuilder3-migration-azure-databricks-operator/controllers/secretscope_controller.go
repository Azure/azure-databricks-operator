...
func (r *SecretScopeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("secretscope", req.NamespacedName)

	// your logic here
	instance := &databricksv1alpha2.SecretScope{}
...
func (r *SecretScopeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&databricksv1alpha2.SecretScope{}).
		Complete(r)
}
