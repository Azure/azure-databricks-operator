...
import (
	...
	"github.com/polar-rams/azure-databricks-operator/controllers"
...
func init() {
	...
	utilruntime.Must(databricksv1alpha2.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5ec8284c.microsoft.com",
	})
	if err != nil {
	...
	if err = (&controllers.SecretScopeReconciler{
