...
func (r *WorkspaceItemReconciler) submit(instance *databricksv1beta1.WorkspaceItem) error {
	...
	instance.Status = &databricksv1beta1.WorkspaceItemStatus{
...
func (r *WorkspaceItemReconciler) delete(instance *databricksv1beta1.WorkspaceItem) error {
